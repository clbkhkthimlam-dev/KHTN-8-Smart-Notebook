  ...
  13: [
    {
      ...
      statement: "Khối lượng riêng của một chất là khối lượng trên một đơn vị thể tích của chất đó. Công thức: D = m / V (hoặc ρ = m / V), trong đó D/ρ có đơn vị kg/m³, m có đơn vị kg và V có đơn vị m³.",
      canonical_explanation: "Khối lượng riêng là đặc tính vật lý của chất, phụ thuộc vào nhiệt độ và áp suất xác định. Với cùng điều kiện, chất tinh khiết có khối lượng riêng không phụ thuộc vào kích thước hay hình dạng mẫu; vật rỗng hoặc vật ghép chỉ cho khối lượng riêng trung bình nếu lấy toàn bộ m/V.",
      terms: ["Khối lượng riêng", "Thể tích", "Khối lượng", "Đơn vị kg/m³", "g/cm³"],
      conditions: "Mẫu phải đại diện cho cùng một chất; nhiệt độ và áp suất phải được xác định. Với vật rỗng hoặc vật ghép, m/V chỉ là khối lượng riêng trung bình của toàn vật.",
      representations: ["text", "formula", "diagram", "simulation"],
