                  ...
                  <div className="mt-4 pt-3 border-t border-slate-800">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {selectedFormula.knownRearrangements.map((r, idx) => (
                        <div key={idx} className="bg-slate-900 border border-slate-700 px-3 py-2 rounded-lg text-center">
                          <MathView math={r.latex} block className="font-bold text-cyan-300" />
                          <div className="text-[10px] text-slate-400 font-sans">{r.meaning}</div>
                        </div>
                      ))}
                    </div>
                  </div>
