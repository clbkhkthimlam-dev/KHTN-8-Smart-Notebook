...
## DOCUMENT EXPORT QA (V4)
- UTF-8 + NFC end-to-end.
- No mojibake / missing Vietnamese diacritics.
- Font coverage and embedding validated.
- DOCX open test + rendered PNG inspection.
- PDF font/Unicode validation + rendered PNG inspection.
- Formula regression in DOCX and PDF.
- Image/caption/source/alt-text validation.
- A4 pagination, margin, table and header/footer validation.
- Export provenance/package hash retained.

### Release blocker P0 bổ sung
- Mất dấu tiếng Việt / mojibake.
- Glyph vuông hoặc font fallback làm sai nội dung.
- PDF/DOCX sai công thức so với Formula Atom.
- Tài liệu in mất hình, caption, nguồn hoặc bài tập đã chọn.
